...
baserate_var=0.25
k_pe = 36
r_pe = 12 #preventative p->e: m=3,var=0.04
k_ge = 9
r_ge = 6  #generative g->e: m=1.5,var=0.04
...
library(parallel)
mclapply(wholelist, MyNorMod1,mc.cores=4)
...
library(parallel)
mclapply(wholelist, MyNorMod2,mc.cores=4)
