...
MyOneMod1<-function(seed){
  ...
  for (sti_num in 1:18){
    ...
    nor_sim_prob=MyOnlineInfer_one(sqc_raw_long,k_e,r_e,k_pe,r_pe,k_ge,r_ge)
...
library(parallel)
mclapply(wholelist, MyOneMod1,mc.cores=4)
...
library(parallel)
mclapply(wholelist, MyOneMod2,mc.cores=4)
