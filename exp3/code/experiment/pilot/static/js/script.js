...
var check_keys=[true,false,true,true,true,true];
...
function ShowExp(){
	while (1){
		myOrder=shuffle([1,2,3,4,5,6,7,8,9]).concat(shuffle([10,11,12,13,14,15,16,17,18]));
...
function ShowNextTrial(){
	...
	document.getElementById("progress_indicator").style.width=Number(47.65*(trialNumber-1))+"px";
	if (trialNumber==0){
