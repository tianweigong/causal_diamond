...
function TrialStart(){
	...
	trial_sqc=this[$('#Experi').val()+"_"+ $('#Seed').val()+"_"+$('#Structure').val()+"_"+$('#Delay').val()]

	if (trial_sqc==undefined){alert("This stimulus doesn't exist! Please try other options : ) ");return}
...
function mychoice(e){
	...
	if ($('#Experi').val()=="exp1"){
		...
		if ($('#Seed').val()!="seed1" && $('#Seed').val()!="seed2"){
			$('#Seed').val("seed1")
		}
	}

	if ($('#Experi').val()=="exp3"){
		if ($('#Seed').val()!="seed1" && $('#Seed').val()!="seed2" && $('#Seed').val()!="seed3" &&
			$('#Seed').val()!="seed4" && $('#Seed').val()!="seed5" && $('#Seed').val()!="seed6" &&
			$('#Seed').val()!="seed7" && $('#Seed').val()!="seed8" && $('#Seed').val()!="seed9" &&
			$('#Seed').val()!="seed10" && $('#Seed').val()!="seed11" && $('#Seed').val()!="seed12"){
